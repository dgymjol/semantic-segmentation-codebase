...
config_dict = {
		'EXP_NAME': 'deeplabv3_ddp_irn_bdsup_1',
		'GPUS': 4,
...
config_dict['TEST_CKPT'] = os.path.join(config_dict['ROOT_DIR'],'model/deeplabv3_ddp_irn_bdsup_1/deeplabv3_contrast_resnet101_VOCDataset_itr30000_all.pth')
