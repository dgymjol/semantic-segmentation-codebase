...
config_dict = {
		'EXP_NAME': 'deeplabv3_ddp_irn_bdsup_2',
		'GPUS': 4,
		...
		'CONTRAST_WARMUP' : 100, #150, #3000
		'EMBEDDING_DIM' : 256,
  
		'SUPCON_LOSS' : True,
		'SUPCON_LOSS_WEIGHT' : 0.7, 
		'HARD_RATIO' : 0.7,
		'SUPCON_MEMORY_SIZE' : 200,
  
		'BDRY_LOSS' : True,
		'BDRY_LOSS_WEIGHT' : 0.7,
		'NUM_ANCHORS' : 100,
		'BD_MEMORY_SIZE' : 1000,
		'TRIPLET_MARGIN' : 0.2, 
		'NEED_GT' : True,
...
config_dict['TEST_CKPT'] = os.path.join(config_dict['ROOT_DIR'],'model/deeplabv3_ddp_irn_bdsup_2/deeplabv3_contrast_resnet101_VOCDataset_itr30000_all.pth')
