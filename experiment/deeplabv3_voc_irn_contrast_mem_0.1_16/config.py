...
config_dict = {
		'EXP_NAME': 'deeplabv3_voc_irn_contrast_mem_0.1_16',
		'GPUS': 4,
		...
		'MODEL_NAME': 'deeplabv3', #deeplabv3_contrast_mem
		...
		'NETWORK_STRIDE' : 8,
		'MODEL_MEM_SIZE' : 10582,
		'PIXEL_UPDATE_FREQ' : 10,
		'CONTRAST_WARMUP' : 2500,
		'LOSS_WEIGHT' : 0.1,
		'TEMP' : 0.1,
		'BASE_TEMP' : 0.07,
		'MAX_SAMPLES' : 1024,
...
config_dict['TEST_CKPT'] = os.path.join(config_dict['ROOT_DIR'],'model/deeplabv3_voc_irn_contrast_mem_0.1_16/deeplabv3_contrast_mem_resnet101_VOCDataset_itr30000_all.pth')
