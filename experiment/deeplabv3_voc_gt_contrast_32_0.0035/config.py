...
config_dict = {
		'EXP_NAME': 'deeplabv3_voc_gt_contrast_32_0.0035',
		'GPUS': 4,
...
config_dict['TEST_CKPT'] = os.path.join(config_dict['ROOT_DIR'],'model/deeplabv3_voc_gt_contrast_32_0.0035/deeplabv3_contrast_resnet101_VOCDataset_itr30000_all.pth')
