...
config_dict = {
		'EXP_NAME': 'deeplabv3_ddp_irn_bdcl_ana',
		'GPUS': 2,
...
config_dict['TEST_CKPT'] = os.path.join(config_dict['ROOT_DIR'],'model/deeplabv3_ddp_irn_bdcl_ana/deeplabv3_resnet101_VOCDataset_itr30000_all.pth')
