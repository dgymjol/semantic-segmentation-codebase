...
config_dict = {
		'EXP_NAME': 'deeplabv3_voc_gt_contrast_mem',
		'GPUS': 4,
...
config_dict['TEST_CKPT'] = os.path.join(config_dict['ROOT_DIR'],'model/deeplabv3_voc_gt_contrast_mem/deeplabv3_contrast_mem_resnet101_VOCDataset_itr30000_all.pth')
