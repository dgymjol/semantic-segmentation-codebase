...
config_dict = {
		'EXP_NAME': 'deeplabv3_ddp_irn_bdcl_test',
		'GPUS': 2,
...
config_dict['TEST_CKPT'] = os.path.join(config_dict['ROOT_DIR'],'model/deeplabv3_ddp_irn_bdcl_test/deeplabv3_contrast_resnet101_VOCDataset_epoch30.pth')
